...
function Newcss({newName="Scaling CSS at Heroku with Utility classNamees",}) {
    console.log("newnewName",newName)
  return (
    <>
    ...
    <div className=" flex items-center space-x-4">
      <img src="https://wallpapercave.com/wp/wp2555019.jpg" alt="" width="88" height="88" className="flex-none rounded-lg bg-slate-100" loading="lazy" />
